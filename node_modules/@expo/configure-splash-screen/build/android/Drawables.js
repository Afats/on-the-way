 ...
 */
async function configureDrawables(androidMainPath, splashScreenImagePath, darkModeSplashScreenImagePath) {
    ...
    await Promise.all([
        copyDrawableFile(splashScreenImagePath, path_1.default.resolve(androidMainPath, DRAWABLES_CONFIGS.default.modes.light.path)),
        copyDrawableFile(darkModeSplashScreenImagePath, path_1.default.resolve(androidMainPath, DRAWABLES_CONFIGS.default.modes.dark.path)),
    ]);
}
